...
def mostrar_menu():
    ...
    unidades = {
        '1': '1_SEMANA2_PILARES_DE_POO',
        '2': '3_SEMANA3_POO',
        '3': '4_SEMANA4_MUNDOREAL_POO',
        '4': '5_SEMANA5_POO',
        '5': '7_SEMANA7_POO',
    }
    ...
    while True:
        ...
        if eleccion_unidad == '0':
            ...
            print(f"Ruta de la unidad seleccionada: {ruta_unidad}")  # Imprimir la ruta para depuración
            if os.path.exists(ruta_unidad):
                mostrar_sub_menu(ruta_unidad)
            else:
                print(f"¡La unidad {unidades[eleccion_unidad]} no existe en la ruta especificada!")
        else:
